...
import { ChevronRight, Armchair, Settings2, Fuel } from "lucide-react";
...
const LatestVehicle = () => {
  ...
  const [LatestVehicledata, setLatestVehicledata] = useState([]);
  const [BookId, setBookId] = useState(null)
  const [show, setShow] = useState(true)

  const LatestVehicleData = async () => {

    const response  = await axios.get(`${app}api/latestvehicle`)
  ...
  return (
    ...
    <>
      ...
      <div className="">
        <div className=" flex justify-around md:justify-between md:items-center lg:grid lg:justify-center mb-9 md:mt-[20px]">
          <div className="hidden md:block font-sans font-semibold text-[48px]   tracking-[2px]  lg:mx-auto  ">
            <span className="text-primary ">Latest</span>  <span>Vehicle</span>

          </div>
          <p className=" text-gray-600 text-[14px]">Check out our latest vehicles—just added and ready to ride! </p>

          <div className="md:hidden lg:hidden font-main font-bold text-xl tracking-[2px] ml-8 mt-4">
            Latest Vehicles
          </div>
        ...
        <div className="grid gap-8 justify-center items-center grid-cols-1  md:grid-cols-2 lg:grid-cols-3  font-sans mt-[-13px]  ">
          {LatestVehicledata.slice(0, 3).map((items, id) => (
            <div key={id} className=" rounded-2xl shadow-[0px_4px_11px_8px_rgba(0,_0,_0,_0.1)] w-auto h-auto mx-4 ">
              ...
              <div className="flex justify-center  md:justify-center lg:justify-between xl:justify-between  m-auto mx-5 mb-4 shadow-red-900">
        ...
        <div className="hidden justify-center lg:mt-20  lg:grid lg:justify-center">
          <Link to="/CompleteLatestCard">
